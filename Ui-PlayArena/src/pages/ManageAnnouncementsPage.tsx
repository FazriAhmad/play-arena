  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Promo & Pengumuman</h1>
          <p className="mt-1 text-sm text-slate-400">Tampil di web (beranda &amp; akun pelanggan) — bukan didorong lewat WA/Email.</p>
        </div>
          ...
          <Card key={a.id} className="p-4">
            <div className="flex flex-wrap items-start justify-between gap-2">
              ...
              <div className="flex gap-3">
                ...
                <button onClick={() => remove(a)} className="text-xs font-semibold text-rose-400 hover:underline">
                  Hapus
                </button>
              </div>
            </div>
