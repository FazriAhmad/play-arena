...
- [ ] **Modul 01–05 selesai** — merge `dev` ke `main` kalau user sudah oke, lalu **lanjut Modul 06** (Pembayaran Online via Midtrans, setelah ACC)
- [ ] Modul 06–10 — sisa Fase 1 (Pembayaran, Kelola Booking Masuk, Riwayat &amp; Invoice, Cancel/Reschedule &amp; Refund, Konfirmasi Admin via WA + Reminder Email)
